                ...
                <form>
                    ...
                    <div class="w-full lg:w-12/12 px-4">
                        ...
                        <div class="relative w-full mb-3">
                            ...
                            <input disabled type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="{{$mhsw_mbkm->}}">
                        </div>
                        <div class="relative w-full mb-3">
                            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2">
                                Sharable URL
