                                    ...
                                    <div class="form">
                                            ...
                                            <div class="w-full flex flex-col mb-3">
                                                ...
                                                <select
                                                    ...
                                                    @foreach($model_mbkm as $mbkm)
                                                        <option value="{{$mbkm->id}}" @if($loop->first) selected @endif >{{$mbkm->model_mbkm}}</option>
                                                    @endforeach
                                                </select>
                                                @error('model_mbkm_id')
                                                <p class="text-sm text-red-500 hidden mt-3">{{ $message }}</p>
                                        ...
                                        <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                            <div class="w-full flex flex-col mb-3">
                                                ...
                                                <input placeholder="NIP Dospem"
                                                       class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                                       required="required" type="number" name="nip_dospem"
                                                       id="nip_dospem">
                                                @error('nip_dospem')
                                                <p class="text-sm text-red-500 hidden mt-3">{{ $message }}</p>
                                                @enderror
                                            ...
                                            <div class="w-full flex flex-col mb-3">
                                                ...
                                                <input placeholder="Nama Dospem"
                                                       class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                                       required="required" type="text" name="nama_dospem"
                                                       id="nama_dospem">
                                                @error('nama_dospem')
                                                <p class="text-sm text-red-500 hidden mt-3">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="flex-auto w-full mb-3 text-xs space-y-4">
                                            ...
                                            <input
                                                ...
                                                class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                                required="required" type="text" name="lokasi_mbkm" id="lokasi_mbkm">
                                            @error('lokasi_mbkm')
                                            <p class="text-sm text-red-500 hidden mt-3">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="flex-auto w-full mb-3 text-xs space-y-2">
                                            ...
                                            <input
                                                ...
                                                class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                                required="required" type="text" name="alamat_mbkm" id="alamat_mbkm">
                                            @error('alamat_mbkm')
                                            <p class="text-sm text-red-500 hidden mt-3">{{ $message }}</p>
                                            @enderror
                                        </div>
